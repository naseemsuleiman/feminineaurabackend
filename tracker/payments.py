...
# Use the secret key for server-side requests
...
def create_checkout_session(request):
    ...
    user = request.user
    # Paystack amounts are in kobo/cents. For KES, 10000 = 100 KES.
    # Example: 1000 KES = 100000 subunit
    ...
    data = {
        "email": user.email or f"{user.username}@feminine-aura.com", # Paystack needs an email
        "amount": amount_in_subunit,
        "currency": "KES", # Set to KES for Kenya
